 ...
 * This fork (ApplyNinjaa) uses a violet palette (primary hue 300).
 *
...
export const theme: Theme = {
  colors: {
    background: { light: "oklch(0.99 0.003 300)", dark: "oklch(0.17 0.02 300)" },
    foreground: { light: "oklch(0.21 0.03 300)", dark: "oklch(0.96 0.008 300)" },
    primary: { light: "oklch(0.55 0.22 300)", dark: "oklch(0.70 0.17 300)" },
    primaryForeground: {
      light: "oklch(0.99 0.003 300)",
      dark: "oklch(0.17 0.03 300)",
    },
    secondary: { light: "oklch(0.955 0.01 300)", dark: "oklch(0.28 0.025 300)" },
    secondaryForeground: {
      light: "oklch(0.3 0.05 300)",
      dark: "oklch(0.96 0.008 300)",
    },
    muted: { light: "oklch(0.955 0.01 300)", dark: "oklch(0.28 0.025 300)" },
    mutedForeground: {
      light: "oklch(0.5 0.025 300)",
      dark: "oklch(0.71 0.02 300)",
    },
    destructive: {
    ...
    border: { light: "oklch(0.91 0.015 300)", dark: "oklch(1 0 0 / 12%)" },
    input: { light: "oklch(0.91 0.015 300)", dark: "oklch(1 0 0 / 16%)" },
    ring: { light: "oklch(0.55 0.22 300)", dark: "oklch(0.70 0.17 300)" },
    card: { light: "oklch(1 0 0)", dark: "oklch(0.21 0.025 300)" },
    cardForeground: {
      light: "oklch(0.21 0.03 300)",
      dark: "oklch(0.96 0.008 300)",
    },
    popover: { light: "oklch(1 0 0)", dark: "oklch(0.21 0.025 300)" },
    popoverForeground: {
      light: "oklch(0.21 0.03 300)",
      dark: "oklch(0.96 0.008 300)",
    },
    accent: { light: "oklch(0.94 0.03 300)", dark: "oklch(0.32 0.045 300)" },
    accentForeground: {
      light: "oklch(0.3 0.06 300)",
      dark: "oklch(0.96 0.008 300)",
    },
  },
  fonts: {
